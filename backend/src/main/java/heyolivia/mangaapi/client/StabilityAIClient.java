package heyolivia.mangaapi.client;
...
// Feign client for interacting with the Stability AI image generation API
@FeignClient(
    name = "stabilityAiClient",
    url = "${stability.api.base-url}",
    configuration = heyolivia.mangaapi.config.FeignConfig.class
)
